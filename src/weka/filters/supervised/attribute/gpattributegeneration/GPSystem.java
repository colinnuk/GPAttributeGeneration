...
public class GPSystem
{
    ...
    {
        //Print tree (dependent on which fitness eval method was chosen)
        if (evalMethod != EnumFitnessEvaluationMethod.FSAR)
        {
            //Add the best tree to the result output
            resultString = resultString + NEW_LINE + "Best Tree: " + NEW_LINE
                + Parse.formatGenomeString(fittestTreeString);
        }
