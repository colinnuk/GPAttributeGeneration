    ...
    implements OptionHandler, SupervisedFilter
{
    ...
    private static final String OPT_FIT_EVAL_QR = "QR";
    private static final String OPT_FIT_EVAL_HYBRID = "H";
    private static final Tag[] OPT_TAGS_FIT_EVAL = {
        new Tag(0, OPT_FIT_EVAL_CLASSIFIER, "J48"),
        new Tag(1, OPT_FIT_EVAL_QR, "FSAR (QuickReduct)"),
        new Tag(2, OPT_FIT_EVAL_HYBRID, "Hybrid J48 & QR")};
    ...
    public Enumeration listOptions()
    {
        ...
        optionList.addElement(new Option("\t" + HELP_FITNESS_EVAL, CMD_FITNESS_EVAL, 1, "-"
                + CMD_FITNESS_EVAL + " <C-J48; QR-FSAR (QuickReduct); H-Hybrid>"));
    ...
    public SelectedTag getFitnessEvaluationMethod()
    {
        ...
        {
            case FSAR: return new SelectedTag(OPT_FIT_EVAL_QR, OPT_TAGS_FIT_EVAL);
            case HYBRID: return new SelectedTag(OPT_FIT_EVAL_HYBRID, OPT_TAGS_FIT_EVAL);
    ...
    public void setFitnessEvaluationMethod(SelectedTag evalMethod)
    {
        if (evalMethod.getTags() == OPT_TAGS_FIT_EVAL)
        {
            ...
            else if(evalMethod.getSelectedTag().getIDStr().equalsIgnoreCase("QR")) {
                fitnessEvaluationMethod = EnumFitnessEvaluationMethod.FSAR; }
            else if(evalMethod.getSelectedTag().getIDStr().equalsIgnoreCase("H")) {
                fitnessEvaluationMethod = EnumFitnessEvaluationMethod.HYBRID; }
